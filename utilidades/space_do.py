...
class SpaceDo():
    ...
    def eliminar(self, pathDestino):
        if pathDestino and pathDestino.strip() != "escandio/usuario_defecto.jpg" and pathDestino.strip() != "escandio/logo_defecto.jpg" and pathDestino.strip() != "escandio/item_defecto.jpg":
