...
class GenConfiguracion(models.Model):   
    ...
    rut_limite_complemento = models.IntegerField(default=1000)
    rut_limite_importacion = models.IntegerField(default=500)
    rut_alertas_intervalo_segundos = models.IntegerField(default=30)
